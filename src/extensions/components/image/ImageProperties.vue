...
<template>
  ...
  />
  <VCheckbox
    v-model="form.labelDisabled" :label="t('editor.image.dialog.form.labelDisabled')"
    hide-details
  />
  <VTextField
    v-if="!form.labelDisabled" v-model="form.label" hide-details
    :label="t('editor.image.dialog.form.label')"
    :prepend-icon="getIcon('imageLabel')"
  />
</template>
